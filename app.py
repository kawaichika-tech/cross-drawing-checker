...
3. 紫色の着色（アクセント天井）の照合:
   ...
   ① 紫色が塗られている領域の【内側】に書かれた室名を確認し、その部屋名で表の天井欄を照合してください。
   ② 斜め天井部分など、紫着色が部屋の一部だけに施されているケースでは、その部屋の室名（例：トイレ、ホール、LDKなど）を慎重に特定してください。隣接する大きな部屋に紫色が及んでいるように見えても、実際には小部屋（トイレなど）のみの可能性があります。
   ③ 【重要】表に天井品番の記載がない部屋は、天井が基本クロス（標準仕上げ）であることを意味します。これは記載漏れではなくエラーでもありません。たとえLDKなどに「斜め天井部分もアクセント施工」といった注記が見えても、その紫着色が実際にはトイレ等の別室のものであれば、LDK天井が表にないことは正常です。紫着色の帰属を誤判定してエラー報告しないでください。
